...
const calculator_ds_datasource_1 = require("../datasources/calculator-ds.datasource");
let CalculatorServiceProvider = class CalculatorServiceProvider {
    constructor(datasource = new calculator_ds_datasource_1.CalculatorDSDataSource()) {
...
CalculatorServiceProvider = __decorate([
    __param(0, core_1.inject('datasources.CalculatorDS')),
